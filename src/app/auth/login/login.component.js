...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.setloginwindow = function () {
        this.loginUrl = this.sanitizer.bypassSecurityTrustResourceUrl(config_1.APP_DATA.authurl + "login?response_type=token&client_id=" + config_1.APP_DATA.appid + "&redirect_uri=" + this.origin() + "/auth.html");
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [auth_service_1.AuthService, application_1.Application, platform_browser_1.DomSanitizer])
], LoginComponent);
